...
{
    class _24_Static_Class_Members
    {
        static void Main(string[] args)
        {
            ...
            Employee employee = new Employee("Ahmo", "Fero", "IT");
            Console.WriteLine("Number of Workers is {0}", Employee.EmployeeNumber);
            Employee employeeTwo = new Employee("Fero", "Ahmo", "IT");
            Employee employeeThree = new Employee("Ahmet", "Altunaş", "IT");
            Console.WriteLine("Number of Workers is {0}", Employee.EmployeeNumber);
